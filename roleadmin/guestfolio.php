    ...
    <div class="col-12">
      <div class="card">
        <div class="card-body">
          ...
          <!-- Form -->
          <form action="guestfolio_store.php" method="post" enctype="multipart/form-data">
              <table cellpadding="4" class="w-100">
                ...
                <label for="pdfFile" class="btn btn-dark rounded-pill"><i class="fa-solid fa-cloud-arrow-up fa-lg"></i> SELECT GUESTBILL</label>
