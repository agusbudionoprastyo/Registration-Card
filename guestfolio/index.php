...
<body>
    <form id="imageForm"> 
        ...
        <button type="button" class="undoClear floating-btn-toggle" id="toggle-btn"><i class="fa-solid fa-bars"></i></button>
        ...
        <button type="button" class="undoClear floating-btn-unpair" id="unpair-btn" style="display:none;"><i class="fa-solid fa-circle-minus" style="color: #ff0000;"></i></button>
