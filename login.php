...
if (isset($_POST['submit'])) {
  ...
  $sql = "SELECT * FROM login WHERE username='$username' AND password='$hashedPassword' LIMIT 1";
  ...
  if ($row) {
    ...
    $errorMsg = "username, password salah / tidak terdaftar. silakan hubungi admin"; // Set the error message
  }
}
?>
...
<head>
  ...
  <title>Login &mdash; Hotel Dafam Semarang</title>
